...
{\small 
	\mZ_{2n+1} =  \begin{pmatrix} \mX_{2n+1} & f(\mX_{2n+1}) \end{pmatrix} = \DATA(f,\veps,\mZ_{n+1},\cg(\mZ_{n+1})) = \begin{pmatrix} \mX_{n+1} & f(\mX_{n+1}) \\ 1/(2n)& f(1/(2n)) \\ 3/(2n) & f(3/(2n)) \\ \vdots & \vdots \\ 1 - 1/(2n) & f(1 - 1/(2n))\end{pmatrix}  \text{ for } \log_2(n) \in \natzero
}
\end{gather*}
