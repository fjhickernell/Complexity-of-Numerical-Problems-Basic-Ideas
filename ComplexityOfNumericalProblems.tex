...
Algorithms for solving numerical problems $(\SOL, \CRIT, \Lambda)$ must collect data about the input function by applying a sequence of data functionals.  The data collection operator $\DATA: \cup_{n \in \natzero} \Lambda^n \times \cg^n \to  \Lambda^n \times \cg^n $ is defined iteratively,
