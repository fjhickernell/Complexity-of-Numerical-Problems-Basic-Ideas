...
\mZ_{2m+1} =  \begin{pmatrix} \mX_{2m+1} & f(\mX_{2m+1}) \end{pmatrix} = \DATA(f,\veps,\mZ_{2m-1}) = \begin{pmatrix} \mX_{2m-1} & f(\mX_{2m-1}) \\ 1/2^m & f(1/2^m) \\ \vdots & \vdots \\ 1 - 1/2^m & f(1 - 1/2^m)\end{pmatrix} \quad \text{for } m \in \naturals
\end{gather*}
